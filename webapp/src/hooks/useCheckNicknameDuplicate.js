 ...
 * @property {function(event): void} onChangeCheckNicknameDuplicate 새로 입력 받는 닉네임의 change핸들러
 * @property {function(): Promise} onClickCheckDuplicateNickname 입력받은 값이 중복되는지 확인 요청보내는 함수
 */
